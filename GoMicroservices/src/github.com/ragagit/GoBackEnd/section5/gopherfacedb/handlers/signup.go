...
import (
	...
	"github.com/ragagit/GoBackEnd/section5/gopherfacedb/models"

	"github.com/ragagit/GoBackEnd/section5/gopherfacedb/validationkit"
)
...
func ProcessSignUpForm(w http.ResponseWriter, r *http.Request, s *SignUpForm, e *common.Env) {
	...
	user, err := e.DB.GetUser(r.FormValue("username"))
	if err != nil {
		log.Print(err)
	} else {
