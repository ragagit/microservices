...
import (
	...
	"github.com/ragagit/GoBackEnd/section5/gopherfacedb/common"
	"github.com/ragagit/GoBackEnd/section5/gopherfacedb/common/datastore"
	"github.com/ragagit/GoBackEnd/section5/gopherfacedb/handlers"
	"github.com/ragagit/GoBackEnd/section5/gopherfacedb/middleware"
...
func main() {
	...
	//err = http.ListenAndServeTLS(WEBSERVERPORT, "../section6/gopherfaceauth/certs/gopherfacecert.pem", "../section6/gopherfaceauth/certs/gopherfacekey.pem", nil)
